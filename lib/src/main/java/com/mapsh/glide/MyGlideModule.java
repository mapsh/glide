...
/**
 * @author mapsh on 2017/12/1 09:46.
 */
...
public class MyGlideModule extends AppGlideModule {
    ...
    public void registerComponents(Context context, Glide glide, Registry registry) {
        OkHttpClient client = new OkHttpClient.Builder().addInterceptor(createInterceptor(new DispatchingProgressListener())).build();
    ...
    private static class DispatchingProgressListener implements ResponseProgressListener {
        ...
        public void update(HttpUrl url, final long bytesRead, final long contentLength) {
            ...
            if (needsDispatch(key, bytesRead, contentLength, listener.getGranulitePercentage())) {
